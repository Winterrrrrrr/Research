...
HD_PWD='C:/Users/Administrator/Desktop/top_matrix_keyboard/top_matrix_keyboard.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log top_matrix_keyboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_matrix_keyboard.tcl
