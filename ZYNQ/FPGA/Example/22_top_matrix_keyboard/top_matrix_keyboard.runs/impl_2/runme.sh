...
HD_PWD='C:/Users/Administrator/Desktop/top_matrix_keyboard/top_matrix_keyboard.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log top_matrix_keyboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_matrix_keyboard.tcl -notrace
