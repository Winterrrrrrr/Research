...
HD_PWD='D:/ZYNQ7020/7010/RLT/16_e2prom_top/e2prom_top.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log e2prom_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source e2prom_top.tcl -notrace
