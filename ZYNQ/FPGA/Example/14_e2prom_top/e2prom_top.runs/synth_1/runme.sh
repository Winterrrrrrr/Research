...
HD_PWD='D:/ZYNQ7020/7010/RLT/16_e2prom_top/e2prom_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e2prom_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e2prom_top.tcl
