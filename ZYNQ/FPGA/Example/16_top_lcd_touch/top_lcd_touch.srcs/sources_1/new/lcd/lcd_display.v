...
//**                    main code
//*****************************************************
assign  data6 = data[31:16] / 10'd1000 % 4'd10 ;  // X轴坐标千位数          
assign  data5 = data[31:16] / 7'd100 % 4'd10   ;  // X轴坐标百位数
assign  data4 = data[31:16] / 4'd10 % 4'd10    ;  // X轴坐标十位数
assign  data3 = data[31:16] % 4'd10            ;  // X轴坐标个位数
assign  data2 = data[15:0]  / 7'd100 % 4'd10   ;  // Y轴坐标百位数
assign  data1 = data[15:0]  / 4'd10 % 4'd10    ;  // Y轴坐标十位数
assign  data0 = data[15:0]  % 4'd10            ;  // Y轴坐标个位数
