...
HD_PWD='C:/Users/Administrator/Desktop/15_hdmi_block_move/hdmi_block_move.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_block_move_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_block_move_top.tcl
