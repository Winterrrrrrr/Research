...
HD_PWD='C:/Users/Administrator/Desktop/15_hdmi_block_move/hdmi_block_move.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_block_move_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_block_move_top.tcl -notrace
