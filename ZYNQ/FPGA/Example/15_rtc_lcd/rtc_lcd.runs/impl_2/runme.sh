...
HD_PWD='G:/ZYNQ/ZYNQ7020/7010/RLT/17_rtc_lcd/rtc_lcd.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log rtc_lcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rtc_lcd.tcl -notrace
