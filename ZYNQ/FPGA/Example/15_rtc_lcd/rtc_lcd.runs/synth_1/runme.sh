...
HD_PWD='G:/ZYNQ/ZYNQ7020/7010/RLT/17_rtc_lcd/rtc_lcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rtc_lcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rtc_lcd.tcl
