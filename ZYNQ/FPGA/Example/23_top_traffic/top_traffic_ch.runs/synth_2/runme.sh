...
HD_PWD='D:/ZYNQ7020/FPGA Design/ZYNQ_7020_FPGA/RLT/top_traffic/top_traffic_ch.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log top_traffic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_traffic.tcl
