...
HD_PWD='D:/ZYNQ7020/FPGA Design/ZYNQ_7020_FPGA/RLT/top_traffic/top_traffic_ch.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log top_traffic.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_traffic.tcl -notrace
